...
<html>
  <head>
    ...
    <title>Resseler Login | We Care</title>
  ...
  <body>
      ...
      <div class="container">
        <div class="form-outer text-center">
          <div class="form-inner">
            ...
            <form id="login-form" role="form" method="POST" action="{{ url('/reseller/login') }}">
              {{ csrf_field() }}
            ...
            </form><a href="{{ url('/reseller/password/reset') }}" class="forgot-pass">Forgot Password?</a>
          </div>
    ...
    <script src="{{ URL::asset('js/reseller/bootstrap.min.js') }}"></script>
    <script src="{{ URL::asset('js/reseller/jquery.cookie.js') }}"> </script>
    <script src="{{ URL::asset('js/reseller/grasp_mobile_progress_circle-1.0.0.min.js') }}"></script>
    <script src="{{ URL::asset('js/reseller/jquery.validate.min.js') }}"></script>
    <script src="{{ URL::asset('js/reseller/jquery.mCustomScrollbar.concat.min.js') }}"></script>
    <script src="{{ URL::asset('js/reseller/front.js') }}"></script>
